        ...
        if (context != null) {
            ...
            for (XNode child : context.getChildren()) {
                ...
                if (isSpecifiedEnvironment(id)) {
                    // 解析 transactionManager 节点，逻辑和插件的解析逻辑很相似
        ...
        if (parent != null) {
            for (XNode child : parent.getChildren()) {
                ...
                if ("package".equals(child.getName())) {
                    ...
                    // 从 typeHandler 节点中解析TypeHandler
                    ...
                    // 根据 javaTypeClass 和 jdbcType 值的情况选择不同的注册策略
        ...
        if (parent != null) {
            for (XNode child : parent.getChildren()) {
                if ("package".equals(child.getName())) {
                    ...
                    // 扫描包下的Mapper，并添加到MapperRegistry
                    ...
                    if (resource != null && url == null && mapperClass == null) {
                        ...
                        throw new BuilderException("A mapper element may only specify a url, resource or class, " +
